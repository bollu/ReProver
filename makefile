...
predict_fstar_last:
	# CONTAINER=native python3 -m retrievalfstar.main predict  --config lightning_logs/version_44/config.yaml --ckpt_path lightning_logs/version_44/checkpoints/last.ckpt/ 
	@echo "running predict on checkpoint '$(LATEST_LIGHTNING_PATH)'"
